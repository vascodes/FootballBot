...
//{
//    internal class FootballChatbot
//    {
...
//    public void Run()
//    {
//        Console.WriteLine("Welcome to the Football Chatbot!");
//        Console.WriteLine("Ask me anything about football/soccer, type 'help' for assistance, or 'exit' to quit.");
...
//            if (userInput == "exit")
//            {
//                Console.WriteLine("Football Chatbot: Goodbye!");
//                break;
//            }
//            else if (userInput == "help")
//            {
//                Console.WriteLine("Football Chatbot: You can ask about football teams, players, rules, leagues, the World Cup, stadiums, or history.");
//                Console.WriteLine("You can also tell me your favorite player by saying 'My favorite player is [player name]' or your favorite team by saying 'My favorite team is [team name]'.");
//                Console.WriteLine("Type 'exit' to quit.");
//            }
//            else
//            {
//                string response = responseGenerator.GenerateResponse(userInput, ref currentContext, userProfile);
//                Console.WriteLine($"Football Chatbot: {response}");
//            }
//        }
//    }
//}
...
//                "There are many football teams to explore. Which one are you interested in?"
//            }
//        },
//        { "players", new List<string>
//            {
//                "Messi, Ronaldo, Neymar, and Salah are some famous football players.",
